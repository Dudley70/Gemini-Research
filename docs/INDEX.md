...
- [technique_library.md](reference/technique_library.md) - Active - **COMPREHENSIVE** All 17 techniques (12 tested + 5 gaps) with examples, compatibility matrix (1,438 lines)
